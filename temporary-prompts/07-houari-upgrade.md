...
The next markdown section shows some inspection commands of the current Hourari app.
...
Outside of this `copilot --yolo` session, I am going to run the GHCP modernization tool. When it completes, I will try to run the app. I expect it will fail. 

Then I will come back to you and ask you to run the same set of inspection commands and capture the output to the file `temporary-prompts/07-houari-post-upgrade.md`.

I will then inspect the output and we'll see how to proceed.
